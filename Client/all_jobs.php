...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto pt-32 font-serif text-blue-900">
        ...
        <!-- Category Slider -->
        <div class="category-slider mb-16 w-fit ml-96">
        ...
        <!-- Job Listings -->
        <div id="jobListings" class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 px-20">
            <?php while ($job = $jobs_result->fetch_assoc()): ?>
                <div class="bg-white text-left shadow rounded-md px-10 py-5 transform transition duration-500 hover:scale-105 job-item"
                    ...
                    <div class="flex justify-center gap-2 mt-4">
                        ...
                        <?php elseif (isset($_SESSION['user_type'])): ?>
                            <a href="job_application_form.php?jid=<?= $job['jid'] ?>"
