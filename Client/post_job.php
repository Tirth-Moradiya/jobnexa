...
<body class="font-roboto bg-gray-100 font-serif">
            ...
            <form action="job_submit.php" method="post" class="space-y-6">
                <div>
                    ...
                    <input type="text" id="jtitle" name="jtitle"
                        class="w-full border-b border-gray-300 focus:outline-none focus:border-blue-500 bg-gray-100 py-2 px-3 placeholder-gray-400 text-gray-900 mb-4"
                ...
                <div>
                    ...
                    <textarea id="jdescription" name="jdescription" rows="6"
                        class="w-full border border-gray-300 focus:outline-none focus:border-blue-500 bg-gray-100 py-2 px-3 placeholder-gray-400 text-gray-900 mb-4"
